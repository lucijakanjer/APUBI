---
title: "Rad s objektima i podacima u R-u"
...
- *__Rad s objektima i podacima te definiranje bioloških varijabli u R-u__*
...
- odabir samo određenih varijabli iz seta podataka - naredba <code>select()</code>
- filtriranje uzoraka oadranih karakteristika - naredba <code>filter()</code>
- kreiranje nove varijable - naredba <code>mutate()</code>
- grupiranje rezultata po varijablama - naredba <code>group_by()</code>
- prikaz rezultata prosjeka varijabli po grupama - <code>naredba summarize()</code>
